...
%{\it Tulenbaev's cube} is a collection of abstract groups and morphisms between them which make the diagram below commute.
Suppose we are given a commutative diagram of groups
\[\xymatrix{
...
\begin{comment}In addition, we require these maps to satisfy the following list of axioms:
\begin{enumerate}
