...
It is clear that $H$ is a functor on the category of commutative rings.
...
\begin{enumerate}
 \item $(a \cdot j_+^*(p), b, \beta) \sim (a, H(p) \cdot b, \beta)$, where $p$ is an element $H(A[t])$;
