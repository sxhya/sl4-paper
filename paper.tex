...
The well-known counterexample of P.~Cohn shows that the $\K_1$-analogue of Serre problem fails for $\K_1(2, -)$ and thus Suslin's result cannot be improved, see~\cite[\S~I.8]{Lam10}
...
As said before, this together with~\cref{thm:horrocks-sl4} allows us to show the following.
