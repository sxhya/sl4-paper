...
\begin{enumerate}
 \item $G_1$ acts on $G_{13}$, $G$ acts on $G_3$ %??? vertical arrows $G_{13} \to G_1$ and $G_3 \to G$ are crossed modules
 ...
 %\item $g_3^1(b)^{h_1g_2^1(a)} = g_3^1(b^{g_1^2(a)})$
 \item for every $z_1, z_2 \in G_3$ one has $z_1^{-1} z_2 z_1 = z_2^{h_3(z_1)}$ (Peiffer)
\end{enumerate}

\end{dfn}
We want to define a relation on the set of triples $V = G_1 \times G_2 \times G_3$.
By definition, two triples $v = (x, y, z)$, $v'=(x', y', z')$ are said to be congruent (denoted $v \sim v'$)
 if there exists a triple $(a, b, c) \in G_{12}\times G_{13} \times G_{23}$ such that
\begin{align}
 x' =& x \cdot g_1^3(b) \cdot g_1^2(a), \\ 
 y' =& g_2^1(a)^{-1} \cdot y \cdot g_2^3(c), \\
...
\end{lemma}
\begin{proof}
\begin{equation*} x'' = x' \cdot g_1^3(b') \cdot g_1^2(a') = 
 x \cdot g_1^3(b) \cdot g_1^2(a) \cdot g_1^3(b') \cdot g_1^2(a') = x \cdot g_1^3(b \cdot b'^{g_1^2(a')^{-1}}) g_1^2(a \cdot a') \end{equation*}
\begin{equation*} y'' = g_2^1(a')^{-1} \cdot g_2^1(a)^{-1} \cdot y \cdot g_2^3(c) \cdot g_2^3(c') = g_2^1(aa')^{-1} \cdot y \cdot g_2^3(cc') \end{equation*}
...
Therefore:
\begin{multline*}
  z'' = g_2^3(c')^{-1} \cdot g_3^1(b')^{-h_2(y')} \cdot z' = g_2^3(c')^{-1} \cdot g_3^1(b')^{- h_2 \left( g_2^1(a)^{-1} \cdot y \cdot g_2^3(c) \right)} g_3^2(c)^{-1} \cdot g_3^1(b)^{-h_2(y)} \cdot z =
  \\ = g_2^3(cc')^{-1} \cdot g_3^1(b')^{- h_2 \left( g_2^1(a)^{-1} \cdot y \right)} \cdot g_3^1(b)^{-h_2(y)} \cdot z = 
       g_2^3(cc')^{-1} \cdot g_3^1(b \cdot b' ^ {g_1^2(a)^{-1}})^{- h_2 \left( y \right)} \cdot z.
\end{multline*}
\end{proof}
