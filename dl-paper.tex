...
%[x_{\alpha_{l-1}}(a),\,x_{\alpha_{l}-\alpha_{l-2}}(N_{\alpha_{l}-\alpha_{l-2},\alpha_{l-2}}bt\inv)].
$$
...
\begin{multline} \nonumber z_\alpha(f, mX) = x_{\alpha+\beta}(\epsilon Xf) \cdot x_{\beta}(-mX^2 f) \cdot x_{-\beta}(mf) \cdot x_\alpha(f) \cdot \\ 
...
\begin{df}
 ...
 \begin{enumerate}
  ...
  \item $c_{\pm \delta}(f, X\xi)$ for some fixed root $\delta \in \Phi$ forming a sharp angle with both $\alpha$ and $\beta$.
 \end{enumerate}
\end{df}
...
\begin{proof}
 ...
 By~\cref{Kgen-strong} we can write $g$ as a product of elements of the above family and generators of the form $c_{\pm \delta}(f, X\xi)$ for $\delta$
 ...
 As a side effect of this transformation, however, factors $x_\alpha(Xf)$ and $x_\beta(Xf)$ appearing in $g$ might be transformed into terms of the form
 ...
 Invoking~\eqref{Z5} of~\cref{Zrels} with $\alpha = \alpha_1$, $\beta = -\alpha_2$, $\eta = 1$, $s = Xf$, $\xi = X\xi$ we can rewrite the term
  $z_\alpha(Xf, X\xi)$ as a product of generators of type 1, 2, 3. Similar argument also applies to $z_\beta(Xf, X\xi)$.  
...
\begin{lemma}
 Let $\alpha, \beta \in \Phi$ be such that $\langle \alpha, \beta \rangle = 0\text{ or }1$.
 Then the image of $K(\alpha, \beta)$ under $S_{\alpha}(a, -)$ is contained in the subgroup of $\St(\Phi, A[X, X^{-1}])$ 
 generated by $K(\alpha, \beta)$ and the subgroup $U$, by definition, generated by $z_\gamma(f, X\xi)$, $\gamma \in Z_+(\alpha) \setminus \{ \alpha - \beta \}$.
