...
The proof of~\cref{thm:P1glueing} requires a certain amount of preparatory work. One of the necessary ingredients is a certain presentation theorem for Steinberg groups similar to the results of U.~Rehmann, C.~Soul{\'e} and M.~Tulenbaev, see~\cref{lemma33} (cf.~\cite[Satz~2]{Re75},\cite[Theorem~2]{RS76},\cite[Lemma~3.3]{Tu83}).
...
It is well known that $P_n$ (resp. $\widetilde{P}_n$) is a normal subgroup of $G_n$ (resp. $\widetilde{G}_n$) for $n\geq 3$ (see~\cite{Su82},\cite{Ta84}). Thus,~\ref{req:subfunc} is satisfied for $P_n$ and $\widetilde{P}_n$.
...
Recall from p.~189 of~\cite{Ba74} that there is an exact sequence
...
Notice that for $n\geq 3$ the groups $\KO_2(2n, R)$ and $\K_2(\rD_n, R)$ are related via the exact sequence
\[ \xymatrix{ 1 \ar[r] & \K_2(\rD_n, R) \ar[r] & \KO_2(2n, R) \ar[r] & \mu_2(R) \ar[r] & 1,} \]
which follows from~\eqref{eq:Bass-ES} via the snake lemma  (cf. also with~\cite[Corollary~4.3.5]{Ba74}).
