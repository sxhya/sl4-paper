...
\begin{proof} Let us fix $g(X) \in K(A[X], M[X])$. By~\cref{thm:Tits} we can write it as $\prod_i z_{\alpha_i}(f_i(X), \xi_i(X))$ for some $f_i(X) = f_i(0) + Xf_i'(X) \in M[X]$, $\xi_i(X) = \xi_i(0) + X\xi_i'(X) \in A[X]$.
 ...
 \scalebox{0.96}{\begin{minipage}{1.04\linewidth}
 \[z_{\alpha_i}(f_i(0), \xi_i(0))^{x_{-\alpha_i}(X\xi'_i(X))} = [x_{-\alpha_i}(-X\xi'_i(X)),\ z_{\alpha_i}(f_i(0), \xi_i(0))] \cdot z_{\alpha_i}(f_i(0), \xi_i(0)).\]\end{minipage}}
...
\scalebox{0.94}{\begin{minipage}{1.06\linewidth}
...
\newline
\scalebox{0.85}{\begin{minipage}{1.16\linewidth}
