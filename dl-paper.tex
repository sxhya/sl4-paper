...
Thus, our main result is the following theorem, which is the orthogonal analogue of~\cite[Theorem~5.1]{Tu83} and the $\K_2$-analogue of~\cite[Theorem~6.8]{Su82} (cf. also with~\cite[Theorem~VI.5.2]{Lam10} and~\cite[Theorem~1.1]{St-poly}).
...
$G = G(\rD_n, -) = \mathrm{Spin}(2n, -)$ as $P = \mathrm{Epin}(2n, -)$ is the elementary subfunctor of $G$.
