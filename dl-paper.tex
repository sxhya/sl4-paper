...
\begin{corollary} \label{K-a-b-cor2}
 One has $\widetilde{P}_\alpha(0) \cap K(A[X], M[X]) =  \widetilde{K}(\alpha, \beta) \cdot X_{-\beta}(M \cdot X).$ 
\end{corollary}
\begin{proof} ??? \end{proof}
...
\begin{lemma} \label{P0_conj-alternative} The subgroup $P_\alpha(0)$ is stable under conjugation by $x_\alpha(aX^{-1})$ for arbitrary $a \in A$. \end{lemma}
