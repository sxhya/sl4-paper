...
\begin{document}
\begin{abstract} We prove a $\mathbb{P}^1$-glueing theorem for even-dimensional orthogonal Steinberg groups. This result transfers to the orthogonal case an earlier result of M.~Tulenbaev and is also an analogue of a result of A.~Suslin and V.~Kopeiko for the functor $\K_2$. \end{abstract}
\maketitle
