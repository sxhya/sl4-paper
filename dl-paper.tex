...
For $n\geq 1$ we define ``truncated'' Steinberg group $\St^{\leq n}(\Phi, B)$ as the quotient of the free group generated by the set $\mathcal{X}_{\leq n}^\Phi$ of homogeneous Steinberg generators of degree $\leq n$ modulo the normal subgroup $\mathcal{R}_{\leq n}^\Phi$ generated by the set of Steinberg relations of degree $\leq n$.
