...
\end{align}
In the above formulae $a, b \in R$ and the integers $N_{\alpha, \beta, 1, 1} = N_{\alpha, \beta} = \pm 1$ are the structure constants of the Lie algebra of type $\Phi$. Although there is still some degree of freedom in their choice, these constants always must satisfy the relations, provided by the following lemma (cf.~\cite[\S~14]{VP}).
