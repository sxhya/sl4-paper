...
We need to introduce notation for certain relations of $\St(\Phi, B)$. 
\begin{align}
&\,\,x_{\alpha}(a)x_{\alpha}(a') =  x_{\alpha}(a+a'),& \tag{R$1_d$} \\
&\,[x_{\alpha}(a),\,x_{\beta}(b)]= x_{\alpha+\beta}(N_{\alpha, \beta} \cdot ab),& \tag{R$2_{d,e}$} \\
&[x_{\alpha}(a),\,x_{\gamma}(b)]= 1,& \alpha \perp \beta,\ \tag{R$3^\bot_{d,e}$} \\
&[x_{\alpha}(a),\,x_{\beta}(b)]= 1,& \alpha - \beta \in \Phi,\ \tag{R$3^\angle_{d,e}$}
\end{align}
where $a, a' \in B_d$, $b\in R_e$. 
...
For $n\geq 1$ we define ``truncated'' Steinberg groups $\St^{\leq n}(\Phi, B)$ by the set of generators $x_\alpha(a)$, $\alpha\in \Phi$, $a\in B_d$, $d\leq n$, and relations $\text{R}1_{d}$, $\text{R3}^\angle_{d, e}$ and $\text{R3}^\bot_{d, e}$ for all $d,e \leq n$ and $\text{R2}_{d,e}$ for those $d,e \leq n$ for which $d+e \leq n$.
...
In the case $1\leq d \leq e \leq n$ the assertion follows from the following computation:
...
\begin{align*} 
 ...
 = 1 & \text{ by $\text{R3}^\bot_{d+e-1,1}$.} \end{align*}
