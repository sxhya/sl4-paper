...
The proof of~\cref{thm:P1glueing} requires a certain amount of preparatory work. One of the necessary ingredients used is~\cref{lemma33}, which is similar to the results of U.~Rehmann, C.~Soul{\'e} and M.~Tulenbaev (cf.~\cite[Satz~2]{Re75},\cite[Theorem~2]{RS76},\cite[Lemma~3.3]{Tu83}).
