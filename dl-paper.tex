...
\begin{df} Define the subgroups $P_\alpha(0)$, $P_{\alpha}(*)$ and $K(\alpha, \beta)$ of $\overline{\St}(\Phi, R, M[X, X^{-1}])$ as the images of the subgroups $\widetilde{P}_{\alpha, M}(0)$, $\widetilde{P}_{\alpha, M}(*)$ and $\widetilde{K}(\alpha, \beta)$ under the natural homomorphism $j_+ \colon \St(\Phi, A[X]) \to \St(\Phi, R)$.\end{df}
