...
\begin{abstract} 
We prove a $\mathbb{P}^1$-glueing theorem for the unstable even-dimensional orthogonal $\K_2$-functor.
This result transfers to the orthogonal case an earlier result of M.~Tulenbaev and is also one of the ingredients needed for the proof of the orthogonal $\K_2$-analogue of Serre's problem. The final result holds for general commutative rings containing $\tfrac{1}{2}$, however some of the intermediate steps in its proof are obtained without this assumption.
\end{abstract}
\maketitle
