...
\end{lemma} \begin{proof} Assume $g_2\in P_\alpha(m')$ for some $m' \in M$, so that $g_1 \cdot g_2 \in P_\alpha(m + m')$. The assertion now follows from the definition of $S_\alpha(a, -)$ and the centrality of Steinberg symbols:
...
\end{align*}
By \cref{P0_conj} and \cref{rem:c-DS} the subgroup $P_\alpha(0)$ contains $S_\alpha(a, g_0)$ and the symbol $\langle a, m \rangle$. Thus, the expression in the right-hand side of the above formula lies in $P_\alpha\left(\tfrac{m}{1+am}\right)$. 
