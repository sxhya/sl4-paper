...
Clearly, $Z_0(\alpha)$ (resp. $Z_+(\alpha)$) is a reductive (resp. special) subset of $\Phi$ (see~\cref{df:root-subsets} for the terminology).
...
In the above formulae and for the rest of this subsection $f \in M[X]$ and $\xi \in A[X]$. Notice also that by~\eqref{Zdef} one has $z_\beta(f, 0) = x_\beta(f)$.
