...
\begin{abstract} We prove a $\mathbb{P}^1$-glueing theorem (also called Horrocks theorem) for the unstable even-dimensional orthogonal Steinberg groups.
Horrocks theorem for Steinberg groups is one of the key ingredients needed for the proof of the $\K_2$-analogue of Serre's problem, 
 positive solution of which currently is only known in the linear case. \end{abstract}
\maketitle
