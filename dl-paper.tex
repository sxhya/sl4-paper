...
\begin{theorem}
 Suppose that $\Phi$ is as in the statement of~\cref{lemma33}. Then the map $j_+\colon \St(\Phi, A[X]) \to \St(\Phi, R)$ is injective.
 
 Suppose, moreover, that $\St(\Phi, A[X]) \to \St(\Phi, B)$ is injective. Then the following square is a pullback square in which all arrows are injective
 \begin{equation} \nonumber
