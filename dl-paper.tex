...
\begin{proof} See~\cite[Corollary~5.3]{Ho05}. 
%This is a special case of~\cite[Theorem~9.13]{Sch16} and the remark that follows it. 
\end{proof}
...
The following lemma summarizes basic properties of structure constants which will be used in our computations below, often without further reference.
...
\begin{equation} \label{eq:cocycle} N_{\beta,\gamma} \cdot N_{\alpha, \beta+\gamma} = N_{\alpha+\beta, \gamma} \cdot N_{\alpha, \beta}. \end{equation}
\end{lemma} \begin{proof} See~\cite[\S~14]{VP}. \end{proof}
