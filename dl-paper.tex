...
If $\langle \beta, \gamma \rangle$ is $0$ or $1$, then $g$ is a generator of type 2 or 3 for $P_\beta(0)$ in the sense of~\cref{defP0}. Finally, if $\gamma = \beta$ the element $g = z_\beta(f, X\xi)$ also belongs to $P_\beta(0)$ (this follows e.\,g. from Remarks~\ref{Pstar-char}--\ref{rem:palpha}). \end{proof}
