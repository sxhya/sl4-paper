...
We denote by $B$ the ring $M[X] + A[X^{-1}]$ considered as a graded subring of $A[X, X^{-1}]$. If we set $t = X^{-1}$, the notation of the present subsection becomes consistent with that of~\cref{sec:presentation}.
