...
In the above statement $\KO_2(2\ell, -)$ denotes the unstable orthogonal $\K_2$-functor (see~\cref{sec:quillen}). Notice also that in the special case when $A=k$ is a field the above theorem follows from the results of U.~Rehmann, J.~Hurrelbrink and J.~Morita (see~\cref{field-injectivity} below).
