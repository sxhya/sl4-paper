...
In our computations we use two explicit families of elements of $\K_2(\Phi, R)$: Steinberg and Dennis--Stein symbols.
Recall that Steinberg symbols are defined for any $s, t \in R^\times$ by the identity
...
Recall that Dennis--Stein symbols are defined for arbitrary $r, s\in R$ satisfying $1 + rs \in R^\times$ as follows:
