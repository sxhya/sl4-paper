...
\begin{enumerate}
 ...
 \item a homorphism $\mu \colon M\to N$ preserving the action of $N$-groups and satisfying {\it Peiffer identity} ${}^{\mu(m)}\!m' = m m' m^{-1}$.
\end{enumerate}
...
\begin{rem} \label{Pstar-char} The above lemma allows us to characterize $P_{\alpha, M}(*)$ as follows: it conincides with the image under $j_+$ of the subgroup 
