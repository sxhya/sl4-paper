...
\begin{lemma} Let $\Phi$ be a simply-laced root system of rank $\geq 3$ and $(A, M)$ be a local pair. Then for $\alpha \in \Phi$ the partial function $t_\alpha(aX^{-1}) \colon V \not \to V$ descends to a well-defined total function 
