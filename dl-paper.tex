...
\subsection{Acknowledgements} \cref{thm41} was obtained by the first-named author who acknowledges the financial support of RSF grant No 17-11-01261.
\cref{thm:P1glueing} was obtained by the second-named author who acknowledges the financial support of JSC Gazpromneft and RFBR grant No 18-31-20044.

The authors would also to express their gratitude to A.~Stavrova for posing the problem and also to A.~Stepanov and N.~Vavilov for many useful comments and their interest in this work.
...
Notice that $\KO_2(2n, R) = \Ker(\St(\rD_\ell, R) \to \mathrm{SO}(2n, R))$ is a larger subgroup of $\St(\rD_\ell, R)$ than $\K_2(\rD_\ell, R)$.
More precisely, from~\cite[157]{Ba74} and Snake lemma it follows that \[\KO_2(2n, R)/\K_2(\rD_n, R) \cong \Ker(\mathrm{Spin}(2n, R) \to \mathrm{SO}(2n, R)) = \mu_2(R).\]
On the other hand, from~\cref{lem:lowerKgroups} it follows that $\KO_3(2n, R)$ is isomorphic to the group $K_3^{G, P}$ in which
$G = G(\rD_n, -) = \mathrm{Spin}(2n, -)$ as $P = \mathrm{Epin}(2n, -)$ is its elementary subfunctor.
