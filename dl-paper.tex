...
\begin{proof}
 ...
 Throughout this proof we understand generator types according to~\cref{defP0}. It is clear that $g$ itself is a generator of type 2, therefore it remains to consider the case $\gamma\not \perp \beta - \alpha$. 
...
Notice that $\langle \gamma + \beta - \alpha, \alpha \rangle = 
  \langle \gamma , \alpha \rangle + \langle \beta , \alpha \rangle - \langle \alpha, \alpha \rangle \geq 1 + 1 - 2 = 0$, therefore the expression in the right-hand side is a product of generators of type 1, 2, 2 or 1, 3, 2. {\bf TODO: } Double check that both possibilities actually occur.

Now suppose that the other alternative holds, namely that $\alpha - \beta + \gamma \in \Phi$.  Since $\langle \beta - \gamma - \alpha , \alpha \rangle = \langle \beta , \alpha \rangle - \langle \gamma , \alpha \rangle - \langle \alpha, \alpha \rangle \leq 1 - 1 - 2 = -2$ we obtain that $\beta - \gamma - \alpha = -\alpha$. Thus, by \eqref{Z3} of~\cref{Zrels}
