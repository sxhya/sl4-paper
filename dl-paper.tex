...
\end{multline}
Denote by $h_0$ the product of all terms except the first and the last one in the above formula. Clearly, $h_0$ is a product of generators of $P_\alpha(0)$ of type 1, 2, 6, 6. Now by~\cref{K-a-b} we can write $g = g_0 x_{-\beta}(m'X) \cdot x_{-\alpha}(mX)$ for $g_0 \in K(\alpha, \beta)$.
