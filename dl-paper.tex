...
Notice that $G_M^0$ can be considered as a subgroup of $\St(\Phi, R)$. Consider the following commutative diagram.
...
\begin{proof} Since $j_- = j_R j_B^-$, where $j_B^-$ is as in~\cref{prop43}, it suffices to show that $j_B^-$ is injective.
 ...
 By~\cref{prop43} holds $v_0 = j_B^-(g) \cdot v_0 = [1, g, 1]$ therefore $g = i_-(\gamma)$ for some $\gamma \in G_M^0$ satisfying $j_+i_+(\gamma) = 1$,
