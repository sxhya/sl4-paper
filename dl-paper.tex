...
It remains to invoke the stability theorem~\cite[Theorem~9.4]{Pa89} to obtain the assertion in the nonstable case. Thus, we see that the result of Morita and Rehmann agrees with the modern literature on higher Grothendieck--Witt groups. \end{rem}
