...
To obtain the assertion in the case $\Phi = \rG_2$ repeat the proof of~\cite[Satz~3]{Hur77} using \cite[Corollary~6]{AM88} instead \cite[Korollar~4]{Hur77}.
...
%which is obtained from~\eqref{eq:Bass-ES} and the snake lemma (cf. also with~\cite[Corollary~4.3.5]{Ba74}). On the other hand, from~\cref{lem:lowerKgroups} it follows that $\KO_3(2n, R) \cong \mathrm{K}_3^{\widetilde{G}_n, \widetilde{P}_n}$.
...
\newline\scalebox{.98}{\begin{minipage}{1.02\linewidth}\begin{align*}
...
\newline \scalebox{0.92}{\begin{minipage}{1.08\linewidth}
\begin{align*}
...
\newline\scalebox{0.97}{\begin{minipage}{1.03\linewidth}
